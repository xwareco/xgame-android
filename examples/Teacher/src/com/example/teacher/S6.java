...
public class S6 implements IstateActions {
	...
	public void onStateEntry(LinearLayout layout, Intent I, Context C, HeadPhone H) {
		...
		String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/Teacher/Sound/error.mp3";
		//score sound
		...
		Toast.makeText(C, "You still have "+(3-failnum)+" tries to go", Toast.LENGTH_LONG).show();
		this.layout = layout;
		if(failnum == 3)
		{

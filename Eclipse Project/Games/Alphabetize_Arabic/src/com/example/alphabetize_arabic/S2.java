...
public class S2 implements IstateActions {
	...
	public void onStateEntry(LinearLayout layout, Intent I, Context C, HeadPhone H) {
		...
		String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/ترتيب الكلمات/Sound/error.mp3";
		//score sound
	...
	OvalShape ov = new OvalShape();
			...
			Drawable d = Drawable.createFromPath(Environment
					...
					+ "/xGame/Games/ترتيب الكلمات/Images/try.png");
	...
	tryAgain.setContentDescription("حاول مرة ثانية");

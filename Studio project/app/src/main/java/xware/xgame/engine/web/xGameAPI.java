...
import xware.xgame.jsonconverters.BoardJsonParameterConverter;
import xware.xgame.jsonconverters.GamesJsonParameterConverter;
...
public class xGameAPI {
	...
	public static String getNewToken(String Flag) {
		...
		System.out.println("Dev id: " + deviceID);
		HttpClient httpclient = new DefaultHttpClient();
		ResponseHandler<String> handler = new BasicResponseHandler();
		String result = "NULL";
		String Final = "";

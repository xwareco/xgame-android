...
public class S1 implements IstateActions {
    ...
    public void onStateEntry(LinearLayout layout, Intent I, Context C,
        ...
        String Path = Environment.getExternalStorageDirectory().toString()
                + "/xGame/Games/سباق السيارات/Sound/car_running.mp3";
        H.setLeftLevel(1);
        H.setRightLevel(1);
    ...
    public Intent loopBack(Context c, Intent I, HeadPhone H) {
        ...
        if (nearestObs != null) {
            ...
            if (obsType.equals("turnleft")) {
                ...
                String Path2 = Environment.getExternalStorageDirectory()
                        .toString() + "/xGame/Games/سباق السيارات/Sound/turn.mp3";
                ...
                // stop current play & play sound
                String Path2 = Environment.getExternalStorageDirectory()
                        .toString() + "/xGame/Games/سباق السيارات/Sound/cow.mp3";
                HeadPhone HP = new HeadPhone(c);
                if (HP.detectHeadPhones() == true) {
                    H.stopCurrentPlay();
                    HP.setLeftLevel(1);
                ...
                // stop current play & play sound
                String Path2 = Environment.getExternalStorageDirectory()
                        .toString() + "/xGame/Games/سباق السيارات/Sound/girl.mp3";
                HeadPhone HP = new HeadPhone(c);
                if (HP.detectHeadPhones() == true) {
                    H.stopCurrentPlay();
                    HP.setLeftLevel(1);
            ...
            if (currVPos == nearestObs.getLocation()
                ...
                if (nearestObs.getType().equals("cow")
                    ...
                    H.stopCurrentPlay();
                    String Path2 = Environment.getExternalStorageDirectory()
                            .toString() + "/xGame/Games/سباق السيارات/Sound/gameover.mp3";
                    H.play(Path2, 0);
        ...
        if (currVPos == 200) {
            H.stopCurrentPlay();
            String Path2 = Environment.getExternalStorageDirectory()
                    .toString() + "/xGame/Games/سباق السيارات/Sound/success.mp3";
            H.play(Path2, 0);
        }

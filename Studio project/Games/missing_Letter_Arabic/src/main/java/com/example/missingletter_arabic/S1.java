...
public class S1 implements IstateActions {
    String[] words = new String[]{"مصر", "السلام", "الشكر", "قِرش", "منتج",
            "عالم", "إختيار", "مدرسة", "منزل", "إهتمام", "رسالة", "صورة",
            "إرتفاع", "ملاعب", "عمل", "معركة", "جيوش", "تخيل", "إحتفال",
            "بحار", "نهاية", "بلدان", "نقود", "محبة", "طلب", "مدفوعات",
            "غابات", "أشجار", "إيمان", "بيع", "ترتيب", "طالب", "بشرية",
            "أخلاق", "الصدق", "الشرطة", "القومية", "إيجابى", "صديق", "أقمار",
            "ضرورى", "تغير", "أمان", "زيادة", "أسواق", "رأى", "خطأ", "أهداف",
            "مخرج", "نصيحة", "فريق", "ملاهى", "عدالة", "تعليمات", "مناقشات",
            "مقبول", "تعليم", "إنتاج", "صناعة", "عميق", "إعلان", "أصوات",
            "فتاة", "نباتات", "حرية", "مفترس", "شركة", "عروض", "ممارسة",
            "تحقيق", "تحسين", "إستثمار", "معرفة", "فقدان"};
    ...
    public void onStateEntry(LinearLayout layout, Intent I, Context C,
        ...
        String Path = Environment.getExternalStorageDirectory()
                .toString()
                + "/xGame/Games/الحرف المفقود/Sound/start.mp3";
        // score sound
    ...
    public void createUI(LinearLayout layout, final Intent I, final Context c) {
        ...
        RoundRectShape rect2 = new RoundRectShape(new float[]{30, 30, 30, 30,
        ...
        LinearLayout.LayoutParams layoutCenterParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT, 100, Gravity.CENTER);
        ...
        // Button firstStyleBtn = (Button)
        // inflater.inflate(R.layout.centerbutton, layout, false);
        ...
        String options = "ابتثجحخدذرزسشصضطظعغفقكلمنهوية";
        Random r = new Random();
        char ch = options.charAt(r.nextInt(options.length() - 1));
        firstLetter.setText(ch + "");
        firstLetter.setTextSize(20);
        ch = options.charAt(r.nextInt(options.length() - 1));
        ...
        switch (n) {
            case 0:
                ...
                break;
            case 1:
                secondLetter.setText(letter + "");
                break;
            case 2:
                thirdLetter.setText(letter + "");
                break;
            case 3:
                forthLetter.setText(letter + "");
                break;
            default:
                break;
        }
        ...
        firstLetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String Path = Environment.getExternalStorageDirectory()
                        .toString()
                        + "/xGame/Games/الحرف المفقود/Sound/Button_best.mp3";
                // score sound
                HeadPhone HP = new HeadPhone(c);
                HP.setLeftLevel(1);
                HP.setRightLevel(1);
                HP.play(Path, 0);
                if (myArabicCollator.compare(firstLetter.getText().toString(),
                        letter + "") == 0) {
        ...
        secondLetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HP.setRightLevel(1);
                HP.play(Path, 0);
                if (myArabicCollator.compare(secondLetter.getText().toString(),
                        letter + "") == 0) {
                    I.putExtra("timeInSecond", time);
        ...
        thirdLetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HP.setRightLevel(1);
                HP.play(Path, 0);
                if (myArabicCollator.compare(thirdLetter.getText().toString(),
                        letter + "") == 0) {
                    I.putExtra("timeInSecond", time);
        ...
        forthLetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                HP.setRightLevel(1);
                HP.play(Path, 0);
                if (myArabicCollator.compare(forthLetter.getText().toString(),
                        letter + "") == 0) {
                    I.putExtra("timeInSecond", time);
    ...
    class RemindTask extends TimerTask {
        ...
        public void run() {
			...
			String Path = Environment.getExternalStorageDirectory().toString()
					+ "/xGame/Games/الحرف المفقود/Sound/timer.mp3";
			Hc.setLeftLevel(1);
			Hc.setRightLevel(1);
			Hc.play(Path, 0);*/

...
public class S1 implements IstateActions {
    String[] words1 = new String[]{"قطع", "كأس", "يموت", "نهاية", "مروحة",
            "غاز", "ثقب", "يملك", "وظيفة", "ورقة", "منزل", "طعام", "مبلل",
            "يحصل"

    };
    String[] words2 = new String[]{"كلمة", "إيمان", "محبة", "صدقة", "بيع",
            "ترتيب", "يفقد", "يعمل", "صورة", "يزرع", "شجرة", "مكان", "حقيبة",
            "مكسب", "زراعة", "قمر"};
    String[] words3 = new String[]{"مدرسة", "منزل", "إهتمام", "رسالة", "مصر",
            "شجاع", "مخرج", "نصيحة", "أشجار", "نباتات", "حرية", "ملعب", "كتاب",
            "معركة", "صرخة"};
    String[] words4 = new String[]{"أراء", "أخطاء", "عدالة", "ملاعب",
            "أعماق", "شجاعة", "ألواح", "بلدان", "معارك", "حدود", "طبيب",
            "مصلحة", "أخلاق", "غابات", "مزرعة"};
    String[] words5 = new String[]{"إحتمال", "عروض", "ممارسة", "مدفوعات",
            "جيوش", "تغيرات", "الأمان", "الزيادة", "أسواق", "حميدة", "البحار",
            "منتجات", "كلمات", "اختيارات",
    ...
    public void onStateEntry(LinearLayout layout, Intent I, Context C,
        ...
        String Path = Environment.getExternalStorageDirectory()
                .toString()
                + "/xGame/Games/مكون الكلمة/Sound/start.mp3";
        // score sound
    ...
    View.OnClickListener handleOnClick(final TextView button, final int index,
        ...
        return new View.OnClickListener() {
            public void onClick(View v) {
                String Path = Environment.getExternalStorageDirectory()
                        .toString()
                        + "/xGame/Games/مكون الكلمة/Sound/Button2.mp3";
                // score sound
                Hc = new HeadPhone(context);
                Hc.setLeftLevel(1);
                Hc.setRightLevel(1);
                ...
                for (int m = workingString.length() - 1; m >= 0; m--) {
                    if (btn2[m].getText().toString().equals("-")) {
                        ...
                        if (myArabicCollator.compare(btn2[m].getText()
                                .toString(), word.substring(word.length() - m
                                - 1, word.length() - m)) == 0) {

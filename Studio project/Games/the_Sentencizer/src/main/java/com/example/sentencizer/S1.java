...
public class S1 implements IstateActions {
    ...
    public void onStateEntry(LinearLayout layout, Intent I, Context c,
        ...
        String Path = Environment.getExternalStorageDirectory()
                .toString()
                + "/xGame/Games/The Sentencizer/Sound/start.mp3";
        // score sound
    ...
    View.OnClickListener handleOnClick(final TextView button, final int index,
        ...
        return new View.OnClickListener() {
            public void onClick(View v) {
                ...
                errorImage.setContentDescription("Wrong Answer");
                ...
                Drawable d = Drawable.createFromPath(Environment
                        .getExternalStorageDirectory().toString()
                        + "/xGame/Games/" + "The Sentencizer" + "/Images/ok.png");
                        ...
                        if (btn[1].getText().toString().equals("")) {
                            if (myArabicCollator.compare(btn[index].getText()
                                ...
                                String Path = Environment
                                        ...
                                        .toString()
                                        + "/xGame/Games/The Sentencizer/Sound/Button_best.mp3";
                                // score sound
                                ...
                                String Path = Environment
                                        .getExternalStorageDirectory()
                                        .toString()
                                        + "/xGame/Games/The Sentencizer/Sound/Button.mp3";
                                // score sound
                                HP = new HeadPhone(context);
                                HP.setLeftLevel(1);
                                HP.setRightLevel(1);

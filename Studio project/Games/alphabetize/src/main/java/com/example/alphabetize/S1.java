...
public class S1 implements IstateActions {
    ...
    public void onStateEntry(LinearLayout layout, Intent I, Context c, HeadPhone H) {
        ...
        String Path = Environment.getExternalStorageDirectory().toString()
                + "/xGame/Games/Alphabetize/Sound/start.mp3";
        // score sound
        ...
        timer = new Timer();
        timer.schedule(new RemindTask(I),
                0,        //initial delay
                1000);
                        ...
                        for (int i = 1; i < 8; i += 2) {
                            ...
                            if (btn[i].getText().toString().equals("")) {
                                ...
                                if (btn[0].getText().toString().equals("") && btn[2].getText().toString().equals("") && btn[4].getText().toString().equals("") && btn[6].getText().toString().equals("")) {
                                    I.putExtra("timeInSecond", time);
                                    Toast.makeText(context, "your time till now: " + time + " second(s) go on you can do it", Toast.LENGTH_SHORT).show();
                ...
                public void run() {
                    ...
                    if (time % 60 == 0 && time < gameTime) {
                        ...
                        Toast.makeText(context,
                                "You have: " + remainingTime + " Minute(s) left",

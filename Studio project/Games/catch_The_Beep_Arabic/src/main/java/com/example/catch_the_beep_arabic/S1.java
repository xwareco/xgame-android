...
public class S1 implements xware.engine_lib.interfaces.IstateActions {
    ...
    HeadPhone pre = null, pre2 = null, Hc = null;
    ...
    public void onStateEntry(LinearLayout layout, Intent I, Context C,
        ...
        String Path = Environment.getExternalStorageDirectory()
                .toString()
                + "/xGame/Games/رد الفعل/Sound/start.mp3";
        // score sound
    ...
    public Intent loopBack(Context c, Intent I, HeadPhone H) {
        ...
        String Path = Environment.getExternalStorageDirectory().toString()
                + "/xGame/Games/رد الفعل/Sound/beep.mp3";
    ...
    class RemindTask extends TimerTask {
        ...
        public void run() {
            /*if (H != null) {
				System.out.println("Timer released");
				H.release();
			}
			H = new HeadPhone(context);
			String Path = Environment.getExternalStorageDirectory().toString()
					+ "/xGame/Games/رد الفعل/Sound/timer.mp3";
			H.setLeftLevel(0.5f);
			H.setRightLevel(0.5f);
			H.play(Path, 0);*/

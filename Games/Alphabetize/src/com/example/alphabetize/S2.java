...
public class S2 implements IstateActions {
	...
	public void onStateEntry(LinearLayout layout, Intent I, Context C, HeadPhone H) {
		...
		String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/The Word Master/Sound/error.mp3";
		//score sound
	...
	tryAgain.setTextColor(0x99FF2400);
		...
		tryAgain.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/The Word Master/Sound/Button.mp3";
				//score sound
				HeadPhone HP = new HeadPhone(c);
				HP.setLeftLevel(1);
				HP.setRightLevel(1);

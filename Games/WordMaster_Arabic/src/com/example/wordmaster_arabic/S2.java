...
public class S2 implements IstateActions {
	...
	public void onStateEntry(LinearLayout layout, Intent I, Context C, HeadPhone H) {
		...
		String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/مكون الكلمة/Sound/error.mp3";
		//score sound
		...
		//Toast.makeText(C, "ما زال لديك  "+(5-failnum)+"  محاول ", Toast.LENGTH_LONG).show();
		this.layout = layout;
		if(failnum ==5)
		{
	...
	tryAgain.setContentDescription("حاول مرة اخر");
	tryAgain.setTextColor(0x99FF2400);
		...
		tryAgain.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/مكون الكلمة/Sound/Button.mp3";
				//score sound
				HeadPhone HP = new HeadPhone(c);
				HP.setLeftLevel(1);
				HP.setRightLevel(1);

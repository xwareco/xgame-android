...
public class S1  implements IstateActions{
	String[] words1 = new String[]{"قطع","كاس","يموت","نهاية","مروحة","غاز","ثقب","يملك","وظيفة","ورقة","منزل"
			,"طعام","مبلل","يحصل"
			
			};
	String[] words2 = new String[]{"كلمة","ايمان","محبة","صدقة","بيع","ترتيب","يفقد","يعمل"
			,"صورة","يزرع","شجرة","مكان","حقيبة","مكسب","زراعة","قمر"
			};
	String[] words3 = new String[]{"مدرسة","منزل","اهتمام","رسالة","مصر","شجاع",
			"مخرج","نصيحة","اشجار","نباتات","حرية","ملعب","كتاب","معركة","صرخة"};
	String[] words4 = new String[]{"اراء","اخطاء","عدالة","ملاعب",
			"اعماق","شجاعة","الواح","بلدان","معارك","حدود","دكتور","مصلحة","اخلاق",
			"غابات",
			"مزرعة"};
	String[] words5 = new String[]{"احتمال","عروض",
			"ممارسة","مدفوعات","جيوش",
			"تغيرات","الامان","الزيادة","اسواق",
			"حميدة","البحار","منتجات","كلمات","اختيارات",
	...
	View.OnClickListener handleOnClick(final TextView button,final int index,final Intent I) {
	    return new View.OnClickListener() {
	        public void onClick(View v) {
	        	String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/مكون الكلمة/Sound/Button2.mp3";
	    		//score sound
	    		...
	    		if (HP.detectHeadPhones() == true)
	    			HP.play(Path, 0);
	        	for(int m =workingString.length()-1;m>=0;m--)
	        	{
	        		if(btn2[m].getText().toString().equals("-"))
	        		{
	        			...
	        			if(myArabicCollator.compare(btn2[m].getText().toString(),word.substring(word.length()-m-1, word.length()-m))==0){
...
class RemindTask extends TimerTask {
    ...
    public void run() {
    	...
    	String Path = Environment.getExternalStorageDirectory().toString() + "/xGame/Games/مكون الكلمة/Sound/timer.mp3";
		Hc.setLeftLevel(1);
   		Hc.setRightLevel(1);
		Hc.play(Path, 0);
      time++;
